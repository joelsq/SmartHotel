...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/css/smart/user/roomService/maintain/maintainRoomDetail.css"
	rel="stylesheet" type="text/css" />
<title>维修管理</title>
</head>
<body>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/smart/user/roomService/maintain/maintainRoomDetail.js"></script>
	<script>
	    // 请求第一页房间报修记录
