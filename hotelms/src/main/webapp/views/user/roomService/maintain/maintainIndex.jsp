		...
		<div class="main-page">
			<div class="nav-path">
				<a href="../roomServiceIndex.jsp" title="回到首页"><i
					...
					href="javascript:void(0);">客房维修</a>
			</div>
			<div class="body">
				<div class="content-title content-title-index">
					<ul>
						<li><div class="icon"></div> <a href="maintainNew.jsp">维修报修</a></li>
						<li><div class="icon"></div> <a href="maintainManage.jsp">维修管理</a></li>
						<li><div class="icon"></div> <a href="maintainStat.jsp">维修统计</a></li>
					</ul>
				</div>
			</div>
		</div>
