...
%>
		...
		<div class="main-page">
			...
			<div class="nav-path">
				<a href="../../home/homeUser.jsp" title="回到首页"><i
					...
					href="maintainCheck.jsp">检查检修</a> <i class="icon-path"></i> <a
					href="maintainCheckNew.jsp">新增检查检修</a>

			</div>

			<div class="bill-area">
				<div>
					<span>房间号:</span><input type="text" id="room" /> <a
						class="btn btn-edit btnEdit" onclick="add();">确认添加</a> <a
						class="btn btn-edit btnEdit" href="maintainCheck.jsp">取消添加</a>

				</div>

				<div class="bill-table">
					<div>
						<span>检修内容:</span><input type="text" /> <span>检查时间:</span><input
					...
					<div style="margin-top: 50px; margin-left: 500px;"
						id="maintainCheckNewBottom" class="bottom"></div>
					<!-- 底部页码 end -->
				</div>
			</div>
		</div>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/smart/user/roomService/maintain/maintainCheckNew.js"></script>
