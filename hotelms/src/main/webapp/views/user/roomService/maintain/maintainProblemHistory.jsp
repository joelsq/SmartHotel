...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/css/smart/user/roomItem/itemRoomOverview.css"
	rel="stylesheet" type="text/css" />
<link
...
<body>
	...
	<div class="main">
		<div class="main-page">
			...
			<div class="nav-path">
				...
				<i class="icon-path"></i> <a href="maintainManage.jsp">维修管理</a> <i
					class="icon-path"></i> <a href="maintainProblemHistory.jsp">历史回复</a>
			</div>

			<div class="nav-path" style="margin-top: -20px;">
				<div>
					<span style="padding-right: 20px;" id="roomnum"></span> <span
						style="padding-right: 20px;" id="des"></span> <span
						style="padding-right: 20px;" id="state"></span> <span
						style="padding-right: 20px;" id="date"></span> <a
						class="btn btn-edit btnEdit btnRight" onclick="exportList();"
						style="margin-left: 285px;">导出</a> <a class="btn btn-edit btnEdit"
						onclick="printList();">打印</a>
				</div>
				<div>
					<span style="padding-right: 20px;" id="roomState"></span> <span
						style="padding-right: 20px;" id="comment"></span> <span
						style="padding-right: 20px;" id="level"></span> <span
						style="padding-right: 20px;" id="type"></span> <span
						style="padding-right: 20px;" id="subtype"></span>
				</div>
			</div>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/smart/user/roomService/maintain/maintainProblemHistory.js"></script>
