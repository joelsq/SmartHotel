...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/css/smart/user/roomService/affairReminder/inboxOverview.css"
	rel="stylesheet" type="text/css" />
<title>收件箱</title>
</head>
<body>
		...
		<div class="main-page">
			...
			<div class="nav-path">
				<span>关键字：</span><input id="keyword" type="text" value=""> <span
					...
					onclick="searchInboxMailRemindersByPage(1);">搜索</a>
			</div>
