...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/css/smart/user/roomService/affairReminder/outboxOverview.css"
	rel="stylesheet" type="text/css" />
<title>发件箱</title>
</head>
<body>
		...
		<div class="main-page">
			...
			<div class="nav-path">
				<span>关键字：</span><input id="keyword" type="text" value=""> <span
					...
					style="margin-left: 30px;" onclick="searchMailReminderByPage(1);">搜索</a>
			</div>
