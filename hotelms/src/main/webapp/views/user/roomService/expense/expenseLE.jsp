...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/css/smart/user/roomService/expense/expenseLE.css"
	rel="stylesheet" type="text/css" />
<link
...
<body>
		...
		<div class="main-page">
			<div class="nav-path">
				<a href="../../home/homeUser.jsp" title="回到首页"><i
					...
					href="expenseLE.jsp?type=<%=type%>"><%=convert(type)+'费'%></a> <a
					class="btn btn-new new" href="newExpense.jsp?type=<%=type%>">新增<%=convert(type)%>费记录
				</a>
			</div>
			...
			<div class="main" style="margin-top: 10px;">
				...
				<div class="main-title">
					<input type="text" placeholder="房间号..." id="roomNumber" /> <a
						class="btnSearch"
						onclick="getExpenseInfo($('#roomNumber').val(),parseInt(1),'<%=type%>');">搜索</a>
					<a class="btn btn-edit" style="margin-left: 10px;"
						onclick="printList('<%=type%>');">打印</a> <a class="btn btn-edit"
						onclick="exportList('<%=type%>');">导出</a>
				</div>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/smart/user/roomService/expense/expenseLE.js"></script>
