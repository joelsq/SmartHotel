...
<body>
		...
		<div class="main-page">
			<div class="nav-path">
				<a href="../roomServiceIndex.jsp" title="回到首页"><i
					...
					href="../service/serviceIndex.jsp">客房费用结算</a> <i class="icon-path"></i>
				<a id="serviceType" href="expenseLE.jsp?type=<%=type%>">LE承担费用</a> <i
					class="icon-path"></i> <a href="javascript:void(0);">新增<%=convert(type)%>费记录
				</a>
			</div>
			<div class="body">
				<div class="body-content">
					<ul>
						<li><span class="span">房间号：</span> <input id="roomNumber"
							type="text" value="W33-2" onblur="associateGuestName(this);" /> <span
							class="red red-right">*&nbsp;必填</span></li>
						<li><span class="span">客户姓名：</span><input type="text"
							id="guestName" disabled="disabled" /></li>
						<li><span class="span">项目：</span><input type="text"
							id="project" value="" /></li>
						<li><span class="span">客服人员：</span><input type="text"
							id="service_staff" value="" /></li>
						<li><span class="span">操作人员：</span><input type="text"
							id="operation_staff" value="" /></li>
						<li><span class="span">原因：</span><input type="text"
							id="reason" value="" /></li>
						<li><span class="span">金额：</span><input type="text" id="cost"
							value="0" />元</li>
						<li><span class="span"></span><a
							onclick="addDate('<%=type%>');" class="btn btn-goback goback">确认添加</a></li>
					</ul>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/smart/user/roomService/expense/newExpense.js"></script>
	<script type="text/javascript">
