...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/css/smart/user/roomService/source/sourceHistory.css"
	rel="stylesheet" type="text/css" />
...
<body>
	...
	<div class="main">
		<div class="main-page">
			...
			<div class="nav-path">
                ...
                %>
				<i class="icon-path"></i> <a id="sourceType" href="<%=content%>"><%=contentOne %></a>
				<i class="icon-path"></i> <a href="javascript:void(0);"><%=contentTwo %></a>
			</div>
			<!-- 面包屑导航 end -->
			<div class="bill-area">
				<div class="label1">
					<span class="key">房间</span><span class="value"><%=rnum%></span> <span
						class="key">初始表数</span><span class="value"><%=init%></span><span
						class="key">年度</span><span class="value"><%=year%></span>
				</div>
				<div class="label2">
					<span class="key">表号</span><span class="value">----</span><span
						class="key">用户姓名</span><span class="value"><%=guest%></span>
				</div>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/smart/user/roomService/source/sourceHistory.js"></script>
	<script type="text/javascript">
