...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/css/smart/user/roomService/source/sourceElec.css"
	rel="stylesheet" type="text/css" />
<title>电费</title>
</head>
<body>
		...
		<div class="main-page">
			...
			<div class="bill-area">
				<input type="text" class="search-input" id="roomNumber"
					...
					onclick="requestElec($('#roomNumber').val(),parseInt(1))">搜索</a>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/smart/user/roomService/source/sourceElec.js"></script>
	<script type="text/javascript">
	    // 拉取第一页电费信息
