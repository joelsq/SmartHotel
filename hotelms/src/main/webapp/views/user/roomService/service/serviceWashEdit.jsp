...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/css/smart/user/roomService/service/serviceNewWash.css"
	rel="stylesheet" type="text/css" />
<title>编辑洗衣单收费</title>
</head>
<body>
	...
	<div class="main">
		<div class="main-page">
			<div class="nav-path">
				...
				<i class="icon-path"></i> <a id="serviceType" href="serviceWash.jsp">洗衣单收费</a>
				<i class="icon-path"></i> <a href="javascript:void(0);">编辑洗衣单收费记录</a>
			</div>
			<div class="body">
				<div class="body-content">
					<ul>
						<li><span>房间号：</span> <input id="serviceRoomNumber"
						...
						<li><span>客户姓名：</span><input id="guestName" type="text"
							value="" disabled="disabled" />
						<li>
						<li><span>发生时间：</span><input type="text"
							class="pack_maintain" />
						<li>
						<li><span>总件数：</span><span id='totalCount'>0</span>&nbsp;件</li>
						<li><span>总价：</span><span id="totalPrice">0</span>&nbsp;元</li>
						<a onclick="updateServiceWashEdit(${param.id});"
							class="btn btn-goback goback">确认更新</a>
					</ul>
				</div>
				<table class="bill-table">
					<thead>
						<tr>
							<th colspan="2">衣服种类</th>
							<th>水洗</th>
							<th>干洗</th>
							<th>单熨</th>
							<th>件数</th>
					...
					<tbody>
						<tr>
							<td class="trTitle" rowspan="4">西装</td>
							<td class="name">西服上衣</td>
							<td class="laundry"></td>
							...
							<td class="price"></td>
							<td><span class="delete">清空</span> <span
								style="display: none" class="unitPrice"></span></td>
						</tr>
						<tr>
							<td class="name">西服裤子</td>
							<td class="laundry"></td>
						...
						<tr>
							<td class="name">西服马甲</td>
							<td class="laundry"></td>
							<td class="dry"><input type="radio" name="suitWaistcoat"><span></span></td>
							<td class="pressing"><input type="radio"
								name="suitWaistcoat"><span></span></td>
							<td><input type="text" value="0"></td>
							<td class="price"></td>
							<td><span class="delete">清空</span> <span
								style="display: none" class="unitPrice"></span></td>
						...
						<tr>
							<td class="trTitle" rowspan="10">上衣</td>
							<td class="name">休闲上衣</td>
						...
						<tr>
							<td class="name">棉马甲</td>
							<td class="laundry"><input type="radio"
								name="cottonWaistcoat"><span></span></td>
						...
						<tr>
							<td class="trTitle" rowspan="3">裤子</td>
							<td class="name">休闲裤</td>
						...
						<tr>
							<td class="trTitle" rowspan="5">裙子</td>
							<td class="name">裙子</td>
						...
						<tr>
							<td class="trTitle" rowspan="4">衬衫</td>
							<td class="name">T恤</td>
						...
						<tr>
							<td class="trTitle" rowspan="8">其他</td>
							<td class="name">睡衣</td>
						...
						<tr>
							<td class="name" onclick="appendOther(this);" index="0"><input
								type="text" value="+&nbsp其他" class="addOther" readonly></td>
							<td colspan="6"></td>
						</tr>
					</tbody>
				</table>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/smart/user/roomService/service/serviceWash.js"></script>
	<script type="text/javascript">
