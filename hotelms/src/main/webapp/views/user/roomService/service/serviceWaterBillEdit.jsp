...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/css/smart/user/roomService/service/serviceNewBusOther.css"
	rel="stylesheet" type="text/css" />
...
<body>
	...
	<div class="main">
		<div class="main-page">
			<div class="nav-path">
				...
				<i class="icon-path"></i> <a href="serviceWaterBill.jsp">饮用水费</a> <i
					class="icon-path"></i> <a href="javascript:void(0);">编辑饮用水费记录</a>
			</div>
			<div class="body">
				<div class="body-content">
					<ul>
						...
						<li><span class="span">房间号：</span> <input
							id="serviceRoomNumber" type="text" value="" disabled="disabled" />
						...
						<li id="dropDownList"><span class="span">水分类：</span> <input
							type="text" id="dropDownInput" value="桶装水" readonly />
						...
						<li><span class="span">发生时间：</span><input type="text"
							class="pack_maintain" disabled="disabled"></li>

						<li><span class="span">数量：</span><input type="text" value="" /></li>
						<li id="unitPrice"><span class="span">单价：</span><input
							type="text" value="0" /></li>
						<li><span class="span">备注：</span><input type="text" value="" /></li>
						<li>
							<div class="eventType">
								<input type="radio" name="eventType" id="eventType"
									checked="checked"><span class="span">现金</span> <input
									type="radio" name="eventType"><span class="span">月结</span>
						...
						<li><span class="span"></span><a
							onclick="updateWaterBill(${param.id});"
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/smart/user/roomService/service/serviceWaterBill.js"></script>
	<script type="text/javascript">
