...
<link
	...
	rel="stylesheet" type="text/css" />
<%--<link href="${pageContext.request.contextPath}/css/smart/user/roomService/service/serviceWash.css" rel="stylesheet" type="text/css"/>--%>
<title>餐费</title>
</head>
<body>
	...
	<div class="main">
		<div class="main-page">
			...
			<a class="btn btn-new btnnew" href="serviceNewTakeaway.jsp"
				style="margin-top: 5px;">新增餐费记录</a>
			<div class="bill-area">
				<div class="search">
					...
					<div style="float: right">
						<a class="btn btn-edit btnEdit"
							onclick="requestFirstTakeawayByRoomNum(this);"
							style="margin-left: 20px;">搜索</a> <a
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/smart/user/roomService/service/serviceTakeaway.js"></script>
	<script type="text/javascript">
    var date = new Date();
