		...
		<div class="main-page">
			<div class="nav-path">
				...
				<i class="icon-path"></i> <a href="serviceBus.jsp">车费</a> <i
					class="icon-path"></i> <a href="serviceBusOther.jsp">其它</a> <i
					class="icon-path"></i> <a href="javascript:void(0);">编辑其它车费记录</a>
			</div>
			<div class="body">
				<div class="body-content">
					<ul>
						...
						<li id="dropDownList"><span class="span">用车种类：</span> <input
							type="text" id="dropDownInput" value="" />
						...
						<li><span class="span"></span><a
							onclick="updateBusOther(${param.id});"
