		...
		<div class="main-page">
			<div class="nav-path">
				...
				<i class="icon-path"></i> <a id="serviceType"
					href="serviceTakeaway.jsp">擦鞋费</a> <i class="icon-path"></i> <a
					href="javascript:void(0);">变更擦鞋费记录</a>
			</div>
			<div class="body">
				<div class="body-content">
					<ul>
						...
						<li><span class="span">数量：</span><input type="text"
							id="count" value="" onblur="auto_sum();" />双</li>
						...
						<li><span class="span"></span><a
							onclick="updateServiceShoeCleaningEdit(${param.id});"
