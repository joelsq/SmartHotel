...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/css/smart/user/roomService/service/serviceNewBusPlane.css"
	rel="stylesheet" type="text/css" />
<title>编辑接送机记录</title>
</head>
<body>
		...
		<div class="main-page">
			<div class="nav-path">
				...
				<i class="icon-path"></i> <a href="serviceBus.jsp">车费</a> <i
					class="icon-path"></i> <a href="serviceBusPlane.jsp">接送机</a> <i
					class="icon-path"></i> <a href="javascript:void(0);">编辑接送机车费记录</a>
			</div>
			<div class="body">
				<div class="body-content">
					<ul>
						<li>
							<div class="eventType">
								<input type="radio" name="eventType" id="eventType"><span
									class="span">接机</span> <input type="radio" name="eventType"
									id="eventType2"><span class="span">送机</span>
							</div>
						</li>
						...
						<li><span class="span">接送人电话：</span><input type="text"
							value="" /></li>
						<li><span class="span">联络人：</span><input type="text" value="" /></li>
						<li><span class="span">联络人电话：</span><input type="text"
							value="" /></li>
						<li><span class="span"></span><a
							onclick="updateBusPlane(${param.id});"
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/smart/user/roomService/service/serviceBusPlane.js"></script>
	<script type="text/javascript">
