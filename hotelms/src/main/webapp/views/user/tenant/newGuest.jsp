...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/css/smart/user/tenant/tenantPublic.css"
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/css/smart/user/tenant/newGuest.css"
	rel="stylesheet" type="text/css" />
<title>房间管理</title>
</head>
<body>
						...
						<div class="tab-content-body">
							<div class="form">
								<div class="item item-name">
									...
									<div class="fl">
										<input type="radio" name="guestType" value="欧美"
											checked="checked" /><span
											style="margin-left: 10px; margin-right: 10px">欧美</span> <input
											type="radio" name="guestType" value="日本" /><span
											style="margin-left: 10px; margin-right: 10px">日本</span> <input
											type="radio" name="guestType" value="其它" /><span
											style="margin-left: 10px;">其它</span>
									</div>
								</div>
								<div class="item item-guestothers">
									<span class="spanLabel">其它租客：</span>
									<div class="fl">
										<input id="guest_others" type="text" class="text"
											value="张三,李四,王五" />
									</div>
									<div class="fl">
										<input type="checkbox" class="checkbox"
											style="display: inline; margin-right: 10px;" /><span
											class="spanLabel">即将入住</span>
									</div>
								</div>
								...
								<div class="item item-birthday">
									...
									<div class="fl">
										<input type="text" class="text pack_maintain"
											style="width: 150px" /> <input id="birthday-reminder"
											type="checkbox" class="checkbox"
											style="display: inline; margin-right: 10px;"
											onclick="clickBirthdayReminder(this);" uid="-1" username=""
											title="" content="" /><span class="spanLabel">设置提醒</span>
									</div>
								...
								<div class="item item-companypay">
									...
									<div class="fl">
										<input type="radio" name="payMode" value="现金"
											checked="checked" /><span
											style="margin-left: 10px; margin-right: 10px">现金</span> <input
											type="radio" name="payMode" value="银行转账" /><span
											style="margin-left: 10px; margin-right: 10px">银行转账</span> <input
											type="radio" name="payMode" value="支票" /><span
											style="margin-left: 10px; margin-right: 10px">支票</span>
									</div>
								</div>
						...
						<div class="tab-content-body">
							<div class="form">
								<div class="item item-type">
									...
									<div class="fl">
										<input type="radio" name="ownerType" value="SPC"
											checked="checked" onclick="clickSPC();" /><span
											style="margin-left: 10px; margin-right: 10px">SPC</span> <input
											type="radio" name="ownerType" value="小业主"
											onclick="clickXiaoYeZhu();" /><span
											style="margin-left: 10px; margin-right: 10px">小业主</span>
									</div>
									<span class="spanLabel">证件号：</span>
									<div class="fl">
										<input type="text" class="text"
											value="09478093845093840593845" />
									</div>
								</div>
								<div class="item item-name" id="xiaoyezhuName"
									style="display: none;">
								...
								<div class="item item-heating-spc-recover"
									style="display: none;">
									<span class="spanLabel">物业费追缴：</span>
									<div class="fl">
										<input type="radio" name="spcRecover" value="不追缴"
											checked="checked" /><span
											style="margin-left: 10px; margin-right: 10px">不追缴</span> <input
											type="radio" name="spcRecover" value="追缴" /><span
											style="margin-left: 10px; margin-right: 10px">追缴</span>
									</div>

									<span class="spanLabel">采暖费追缴：</span>
									<div class="fl">
										<input type="radio" name="heatingRecover" value="不追缴"
											checked="checked" /><span
											style="margin-left: 10px; margin-right: 10px">不追缴</span> <input
											type="radio" name="heatingRecover" value="追缴" /><span
											style="margin-left: 10px; margin-right: 10px">追缴</span>
									</div>
								</div>
							...
							<div class="form">
									...
									<div class="item item-cycle">
										...
										<div class="fl">
											<input type="text" class="text" value="0"
												...
												style="margin-left: 10px; margin-right: 10px">年</span> <input
												type="text" class="text" value="1" style="width: 50px;" /><span
												style="margin-left: 10px; margin-right: 10px">月</span>
										</div>
										<%--<div class="fl">--%>
										<%--<input type="text" class="text pack_maintain" />--%>
										<%--</div>--%>
								...
								<div class="item-list item-rent">
									<div class="item item-cycle">
										...
										<%--<input type="text" class="text pack_maintain"/>--%>
										<%--</div>--%>
										<input type="text" class="text" value="0" style="width: 50px;" /><span
											style="margin-left: 10px; margin-right: 10px">年</span> <input
											type="text" class="text" value="1" style="width: 50px;" /><span
											style="margin-left: 10px; margin-right: 10px">月</span>
									</div>
								...
								<table>
									...
									<tbody>
										...
										<tr class="col-Int">
											...
											<td><input type="checkbox" giveMoney="0" giveComment=""
												onclick="clickGive(this);" /></td>
											<td></td>
										</tr>
						...
						<div class="tab-content-body">
							<div class="form">
								<form modelAttribute="user" method="post"
									...
									<!--提交按钮-->
									<input type="submit" id="requestUploadBtn"
										style="display: none;" value="" /> <input id="guestId"
										name="guestId" value="-1" style="display: none;">
								</form>
							</div>
						</div>
					</div>
	...
	<div id="newGiveMenu" class="addItemDiv">
		<div class="facContent">
			<div class="fac-title">
				赠送详情 <span onclick="closeGiveDiv();">×</span>
			</div>
			<div class="fac-body">
	...
	<!-- 生日提醒弹出框start -->
	<div id="newBirthdayReminderMenu" class="addItemDiv"
		style="height: 500px;">
		<div class="facContent">
			<div class="fac-title">
				生日提醒 <span onclick="closeBirthdayReminderMenu();">×</span>
			</div>
			<div class="fac-body" style="overflow-y: none;">
				...
				<div id="reminder-title" class="item">
					...
					<div class="item-content">
						<input id="reminderTitle" type="text" value="" />
					</div>
				</div>
			...
			<div class="fac-foot">
				<span id="currentDate" style="display: none"></span> <a
					...
					onclick="addBirthdayReminder();">确认</a>
			</div>
		</div>
	</div>
	<!-- 生日提醒弹出框 end -->
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/smart/user/tenant/newGuest.js"></script>
