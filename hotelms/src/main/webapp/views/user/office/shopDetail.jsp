...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/css/smart/user/office/shopDetail.css"
	rel="stylesheet" type="text/css" />
<title>商品销售详情</title>
</head>
<body>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/smart/user/office/shopDetail.js"></script>
	<script type="text/javascript">
        var date = new Date();
