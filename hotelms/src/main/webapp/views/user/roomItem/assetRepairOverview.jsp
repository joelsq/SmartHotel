	...
	<div class="main">
		<div class="main-page">
			...
			<div class="nav-path">
				...
				<i class="icon-path"></i> <a href="itemIndex.jsp">客房物品管理</a> <i
					class="icon-path"></i> <a href="assetRepairOverview.jsp">LE资产报修</a>
			</div>

			<a class="btn btn-new btnnew" href="assetRepairNew.jsp">新增报修</a>

			<div class="nav-path" style="margin-top: -20px;">
				<span>房间号：</span><input id="roomNum" type="text" value=""> <span
					style="margin-left: 30px;">申报时间：</span><input type="text"
					class="pack_maintain" id="reflectDate" /> <a
					class="btn btn-edit btnEdit" style="margin-left: 30px;"
					onclick="searchProblemsByPage(1);">搜索</a> <a
