...
var requestFacSta = function(){
	...
	$.ajax({
		url:'/SMART/userItem/searchFacSta.action',
		type:'post',
		dataType:'json',
...
var requestRoomItem = function (pageNum) {
	...
	$.ajax({
		url:'/SMART/userItem/searchFacDetail.action',
		type:'post',
		dataType:'json',
		contentType:'application/json',
...
var requestTransferFac = function(){
	...
	$.ajax({
		url:'/SMART/userItem/transferFac.action',
		type:'post',
		dataType:'json',
		contentType:'application/json',
...
var requestToWarehouse = function(){
	...
	// 将物品回仓库
	$.ajax({
		url:'/SMART/userItem/toWarehouse.action',
		type:'post',
		dataType:'json',
		contentType:'application/json',
		data:JSON.stringify({"recID" : recID,
...
var requestFacRepair = function(){
    ...
    $.ajax({
        url:'/SMART/userItem/facRepair.action',
        type:'post',
        dataType:'json',
        contentType:'application/json',
...
var finishRepair = function(element) {
    ...
    //请求维修完成
    $.ajax({
        url:'/SMART/userItem/facFinishRepair.action',
        type:'post',
        dataType:'json',
        contentType:'application/json',
...
var requestFacBad = function(element){
	...
	$.ajax({
		url:'/SMART/userItem/facBad.action',
		type:'post',
		dataType:'json',
		contentType:'application/json',
		data:'{"recID":'+ recID +'}',
...
var requestFacRepairToBad = function(element){
    ...
    $.ajax({
        url:'/SMART/userItem/facRepairToBad.action',
        type:'post',
        dataType:'json',
        contentType:'application/json',
        data:'{"recID":'+ recID +'}',
...
var requestNewDistribute = function(){
	...
	$.ajax({
		url:'/SMART/userItem/newDistribute.action',
		type:'post',
		dataType:'json',
		contentType:'application/json',
...
var requestNewBorrow = function(){
    ...
    $.ajax({
        url:'/SMART/userItem/newBorrow.action',
        type:'post',
        dataType:'json',
        contentType:'application/json',
...
var showBackModal = function(element){
    ...
    //查询该物品当前所在的仓库号
    $.ajax({
        url:'/SMART/userItem/getFacRepoNum.action',
        type:'post',
        dataType:'json',
        contentType:'application/json',
        data:JSON.stringify({"recID" : recID}),
...
var requestNewFacBorrow = function(){
    ...
    $.ajax({
        url:'/SMART/userItem/newFacBorrow.action',
        type:'post',
        dataType:'json',
        contentType:'application/json',
...
var requestNewFacRepair = function(){
    ...
    $.ajax({
        url:'/SMART/userItem/newFacRepair.action',
        type:'post',
        dataType:'json',
        contentType:'application/json',
...
var requestNewFacBad = function(){
	var count = Number($("#facBadMenu input").val());
	$.ajax({
		url:'/SMART/userItem/newFacBad.action',
		type:'post',
		dataType:'json',
		contentType:'application/json',
		data:'{"facID":'+ facID +',"count":'+ count +'}',
