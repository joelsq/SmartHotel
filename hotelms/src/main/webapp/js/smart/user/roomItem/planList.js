...
var requestPlanList = function(pageNum){
	...
	$.ajax({
		url:'/SMART/userItem/searchPlanList.action',
		type:'post',
...
var requestPlanDetail = function(element){
	...
	window.location.href = "http://" + window.location.host 
		 + "/SMART/views/user/roomItem/planDetail.jsp?planID=" + planID + "&planName=" + planName;
}
...
var requestItemByItemType = function(){
	...
	$.ajax({
		url:'/SMART/userItem/searchPlanByPlanId.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
		data:'{"PlanId":"'+ plan_id +'"}',
