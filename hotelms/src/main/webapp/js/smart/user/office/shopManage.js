...
var requestShopList = function(pageNum){
	...
	$.ajax({
		url:'/SMART/userItem/searchGoodsList.action',
		type:'post',
		dataType:'json',
...
var addPerGoods = function(perRecord){
	$("#shopListTbody").append("<tr><td>"+ perRecord.name +"</td>"+
		...
		"<td>"+ perRecord.total_SOSMART +"</td><td>"+ perRecord.total_LOSS +"</td>"+
...
var requestBuyGoods = function(){
	...
	var total = per * count;
	$.ajax({
		url:'/SMART/userItem/buyGoods.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
...
var requestSaleGoods = function(){
	...
	var total = per * count;
	$.ajax({
		url:'/SMART/userItem/sellGoods.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
...
var requestUseGoods = function(){
	...
	var total = per * count;
	$.ajax({
		url:'/SMART/userItem/wasteGoods.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
...
var deleteGoods = function(element) {
	...
	$.ajax({
		url:'/SMART/userItem/deleteGoods.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
        data:'{"ID":' + id + '}',
