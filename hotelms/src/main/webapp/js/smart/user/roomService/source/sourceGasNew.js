...
var addSourceGas = function(){
	...
	$.ajax({
		url:'/SMART/userRoom/addSourceGas.action',
		type:'post',
		...
		success:function(data){
			...
			if(data == 1){
				...
				// 	    	"/SMART/views/user/roomService/source/sourceGas.jsp";
			} else if (data == 0){
...
var associateSource = function (element){
    ...
    $.ajax({
        type:'post',
        url:'/SMART/userRoom/getGasSourcesInfo.action',
        contentType:'application/json',
        dataType:'json',
        data:'{"rNum":"' + num + '"}',
        success:function(data){
...
var requestAjaxRate = function(){
    ...
    $.ajax({
        type:"post",
        url:"/SMART/userRoom/getRate.action",
        success:function(data){
            console.log(data);
            // 显示水费标准
