...
var searchMailReminderByPage = function(pageNum){
	...
	$.ajax({
		url:'/SMART/reminder/searchMailRemindersByPage.action',
		type:'post',
		dataType:'json',
...
var requestAddMailReminder = function(){
	...
	$.ajax({
		url:'/SMART/reminder/addMailReminder.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
...
var searchMailReminderDetail = function(id){
	...
	$.ajax({
		url:'/SMART/reminder/searchMailReminderById.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
...
var requestDeleteMailReminder = function(id){
	...
	$.ajax({
		url:'/SMART/reminder/deleteMailReminderById.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
		data:JSON.stringify({"id":id}),
...
var updateMailReminder = function(id){
	...
	$.ajax({
		url:'/SMART/reminder/updateMailReminderById.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
        data:JSON.stringify({"id" : id,
