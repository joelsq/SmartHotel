...
var requestStaff=function(duty){
	...
	$.ajax({
		url:'/SMART/HomeUser/searchAllUsers.action',
		type:'get',
		dataType:'json',
...
var requestRestaurant=function(){
    ...
    $.ajax({
        url:'/SMART/userRoom/searchRestaurant.action',
        type:'get',
        dataType:'json',
        success:function(data){
            console.log(data);
...
var addTakeawayServiceAjax = function(){
	...
	$.ajax({
		url:'/SMART/userRoom/addTakeaway.action',
		type:'post',
...
var searchTakeawayById = function(id){
	...
	$.ajax({
		url:'/SMART/userRoom/searchMealById.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
...
var updateServiceTakeawayEdit = function(id){
	...
	$.ajax({
		url:'/SMART/userRoom/updateMealById.action',
		type:'post',
		contentType:'application/json',
		data:'{"roomNumber":"'+ roomNumber + '","guestName":"'+ guestName +'",'
			  +'"count":'+ count + ',"note":"'+ note +'","time":"' + time + '","res":"'
...
var addShoeCleaningServiceAjax = function(){
	...
	$.ajax({
		url:'/SMART/userRoom/addShoeCleaning.action',
		type:'post',
		contentType:'application/json',
		data:'{"roomNumber":"'+ roomNumber + '","guestName":"'+ guestName +'",'
...
var searchShoeCleaningById = function(id){
	console.log("查询"+id+"号餐费记录");
	$.ajax({
		url:'/SMART/userRoom/searchShoeCleaningById.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
		data:JSON.stringify({"id":id}),
...
var updateServiceShoeCleaningEdit = function(id){
	...
	$.ajax({
		url:'/SMART/userRoom/updateshoeCleaningById.action',
		type:'post',
		contentType:'application/json',
		data:'{"roomNumber":"'+ roomNumber + '","guestName":"'+ guestName +'",'
		  +'"count":'+ count + ',"note":"'+ note +'","time":"' + time + '","pay_for":"' + pay_for + '","sum":' 
...
var addShoppingServiceAjax = function(){
	...
	$.ajax({
		url:'/SMART/userRoom/addShopping.action',
		type:'post',
		contentType:'application/json',
		data:'{"roomNumber":"'+ roomNumber + '","guestName":"'+ guestName +'",'
...
var searchShoppingById = function(id){
	...
	$.ajax({
		url:'/SMART/userRoom/searchShoppingById.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
		data:JSON.stringify({"id":id}),
...
var updateServiceShoppingEdit = function(id){
	...
	$.ajax({
		url:'/SMART/userRoom/updateShoppingById.action',
		type:'post',
		contentType:'application/json',
		data:'{"roomNumber":"'+ roomNumber + '","guestName":"'+ guestName +'",'
		  +'"item":"'+ item +'","count":'+ count + ',"sum":'+ sum + ',"tip":'+ tip +',"note":"'+ note +'","time":"' + time + 
...
var associateCleaningShoesSum = function() {
	...
	if(room != "" && end != 0){
		$.ajax({
			url:'/SMART/userRoom/searchShoeCleaningPrice.action',
			type:'post',
			contentType:"application/json",
			dataType:'json',
			data:'{"roomNum":"' + room + '"}',
