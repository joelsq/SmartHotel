...
var searchBusPlane = function(pageNum){
	...
	$.ajax({
		url:'/SMART/userRoom/searchFlightPickingByRoomNumber_Time.action',
		type:'post',
		dataType:'json',
...
var requestAddBusPlane = function(){
	...
	$.ajax({
		url:'/SMART/userRoom/addFlightPicking.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
...
var searchBusPlaneEdit = function(id){
	...
	$.ajax({
		url:'/SMART/userRoom/searchFlightPickingById.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
...
var serviceBusPlaneDelete = function(id){
	...
	$.ajax({
		url:'/SMART/userRoom/deleteFlightPickingById.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
		data:JSON.stringify({"id":id}),
...
var updateBusPlane = function(id){
	...
	$.ajax({
		url:'/SMART/userRoom/updateFlightPickingById.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
		data:'{"time":"'+ time +'","roomNum":"'+ roomNum +'","guestName":"'+ guestName +'","type":"'+ type +'",'
...
var exportList = function(){
	...
	$.ajax({
		url:'/SMART/userRoom/searchAllFlightPickings.action',
		type:'post',
		dataType:'json',
...
var exportFormat = function(id) {
	$.ajax({
		type:'post',
		url:"/SMART/userRoom/exportFlightPickingById.action",
		contentType:'application/json',
		dataType:'json',
		data:'{"id":"' + id + '"}',
		success:function(data){
            ...
            if(data == 1){
                window.location.href = "http://" + window.location.host + "/SMART/download.action?fp=excel/flightpicking.xlsx";
            }
            else{
