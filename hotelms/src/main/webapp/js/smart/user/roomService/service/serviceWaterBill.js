...
var searchWaterBill = function(pageNum){
	...
	$.ajax({
		url:'/SMART/userRoom/searchWaterBillsByPage.action',
		type:'post',
		dataType:'json',
...
var requestAddWaterBill = function(){
	...
	$.ajax({
		url:'/SMART/userRoom/addWaterBill.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
...
var searchWaterBillEdit = function(id){
	...
	$.ajax({
		url:'/SMART/userRoom/searchWaterBillById.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
...
var serviceWaterBillDelete = function(id){
	...
	$.ajax({
		url:'/SMART/userRoom/deleteWaterBillById.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
		data:JSON.stringify({"id":id}),
...
var updateWaterBill = function(id) {
	...
	$.ajax({
		url:'/SMART/userRoom/updateWaterBillById.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
		data:JSON.stringify({"id" : id,
...
var exportList = function(){
	...
	$.ajax({
		url:'/SMART/userRoom/searchAllWaterBills.action',
		type:'post',
		dataType:'json',
