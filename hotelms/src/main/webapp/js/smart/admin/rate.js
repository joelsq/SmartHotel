...
var requestAjaxRate = function(){
	...
	$.ajax({
		type:"post",
		url:"/SMART/HomeAdmin/getRate.action",
...
var EditRatePage = function(){
	...
	$.ajax({
		...
		success:function(data){
			...
			$("body").append("<a class='btn btn-goback btngoback' href='/SMART/views/admin/rateList.jsp'>返&nbsp;&nbsp;回</a>");
		}
	});
}
...
var setRate = function(){
	...
	$.ajax({
		url:'/SMART/HomeAdmin/setRate.action',
		type:'post',
	    ...
	    success:function(data){
	    	...
	    	if(data == 1) {
				alert("收费标准变更成功！");
	    		window.location.href = "/SMART/views/admin/rateList.jsp";
	    	} else if (data == 0){
	    		alert("收费标准变更失败！");
	    	}
	    }
...
var requestClothesUnitPrice = function(){
	...
	$.ajax({
		url:'/SMART/HomeAdmin/getLaundryPrice.action',
		type:'post',
		dataType:'json',
		contentType:'application/json',
		success:function(data){
...
var setLaundray = function(){
	...
	$.ajax({
		url:'/SMART/HomeAdmin/setLaundryPrice.action',
		type:'post',
		dataType:'json',
		...
		success:function(data){
	    	...
	    	if (data == 1) {
	    		alert("洗衣费单价变更成功！");
	    		window.location.href = "/SMART/views/admin/rateLaundry.jsp";
	    	} else if (data == 0){
	    		alert("洗衣费单价变更失败！");
	    	}
		}
...
var requestAjaxCharge = function(){
	$.ajax({
		type:'post',
		url:'/SMART/HomeAdmin/getCharge.action',
	    success:function(data){
...
var setCharge = function(){
	...
	$.ajax({
		type:'post',
		url:'/SMART/HomeAdmin/setCharge.action',
	    contentType:'application/json',
	    ...
	    success:function(data){
	    	...
	    	if (data == 1) {
	    		alert("收费标准变更成功！");
	    		window.location.href = "/SMART/views/admin/rateOther.jsp";
	    	} else if (data == 0){
	    		alert("收费标准变更失败！");
	    	}
	    }
