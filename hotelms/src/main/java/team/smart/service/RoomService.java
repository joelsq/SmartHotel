...
public interface RoomService {
	...
	List<Laundry> getAllWashes(String rn, String date);  
	...
	int getTotalFlightPickingByRoomNumber_Time(String roomNumber, String time); 
	List<FlightPicking> getAllFlightPickings(String roomNumber, String time);  
	List<FlightPicking> getFlightPickingByRoomNumber_Time(String roomNumber, String time, int startPage, int eachPage); 
	...
	int getTotalOtherFares(String roomNum, String occurTime);  
    List<OtherFare> getOtherFaresByPage(String roomNum, String occurTime, int startPage, int eachPage); 
    List<OtherFare> getAllOtherFares(String roomNum, String occurTime);  
    ...
    int getTotalDrinkingWaters(String roomNum, String occurTime); 
    List<DrinkingWater> getDrinkingWatersByPage(String roomNum, String occurTime, int startPage, int eachPage); 
    List<DrinkingWater> getAllDrinkingWaters(String roomNum, String occurTime);  
