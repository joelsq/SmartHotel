...
import team.smart.service.ItemService;
import team.smart.service.RoomService;
import team.smart.service.ServerService;
import team.smart.service.UserService;
import team.smart.utils.*;
...
//	}
	...
	@RequestMapping("/searchWash") // roomNum为null时，查询所有记录       新增返回合计数值
	@ResponseBody
