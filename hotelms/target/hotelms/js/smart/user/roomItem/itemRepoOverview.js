...
var requestItemOverview = function(pageNum){
	...
	$.ajax({
		url:'/SMART/userItem/searchItemRepoOverview.action',
		type:'post',
...
var showItemDetail = function(element, itemID){
	...
	window.location.href = "http://" + window.location.host
	 	+ "/SMART/views/user/roomItem/itemDetail.jsp?itemID=" + itemID;
};
...
var exportList = function(){
    ...
    $.ajax({
        url:'/SMART/userItem/searchAllItemRepoOverview.action',
        type:'post',
        dataType:'json',
