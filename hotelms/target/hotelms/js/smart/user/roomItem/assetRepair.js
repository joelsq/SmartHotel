...
// 		$.ajax({
// 			url:'/SMART/userItem/getItemType.action',
// 			type:'post',
// 			async:false,
...
// 	// 获取物品名称
// 	$.ajax({
// 		url:'/SMART/userItem/getItemCat.action',
// 		type:'post',
...
// 	// 获取物品品牌
// 	$.ajax({
// 		url:'/SMART/userItem/getItemCom.action',
// 		type:'post',
// 		data:'{"type":"'+ $(element).text() +'"}',
// 		dataType:'json',
// 		contentType:'application/json',
...
//
// 	$.ajax({
// 		url:'/SMART/userItem/newPlan.action',
// 		type:'post',
...
//     //请求添加种类
//     $.ajax({
//         url:'/SMART/userItem/addItemType.action',
//         type:'post',
...
//     //请求添加种类
//     $.ajax({
//         url:'/SMART/userItem/addItemSubType.action',
//         type:'post',
...
//     //请求添加种类
//     $.ajax({
//         url:'/SMART/userItem/addItemBrand.action',
//         type:'post',
//         data: JSON.stringify({typeName: typeName, name: name}),
//         dataType:'json',
//         contentType:'application/json',
...
(function(){
    ...
    // 拉取分类
    $.ajax({
        url: '/SMART/problem/getProbType.action',
        type:'get',
        dataType:'json',
        success: function(data) {
            ...
            $("#problemTypeDropDownList .dropDownMenu li").click(function(){
                ...
                // 拉取子类
                $.ajax({
                    url: '/SMART/problem/getProbSubtype.action',
                    type:'post',
                    dataType:'json',
                    contentType:'application/json',
                    data:'{"type":"'+ waterType +'"}',
...
var associateGuestName = function(element){
    ...
    $.ajax({
        url:'/SMART/userRoom/searchGuestName.action',
        type:'post',
        dataType:'json',
...
var requestNewProbType = function() {
    ...
    // 请求添加种类
    $.ajax({
        url:'/SMART/problem/addProbType.action',
        type:'post',
        data: JSON.stringify({name: name}),
        dataType:'json',
        contentType:'application/json',
...
var requestNewProbSubType = function() {
    ...
    // 请求添加种类
    $.ajax({
        url:'/SMART/problem/addProbSubType.action',
        type:'post',
        data: JSON.stringify({typeName: typeName, name: name}),
        dataType:'json',
        contentType:'application/json',
...
var addProblem = function() {
    ...
    // 添加问题
    $.ajax({
        url: '/SMART/problem/addProblem.action',
        type: 'post',
        dataType: 'json',
        contentType: 'application/json',
        data: JSON.stringify({
...
var addProblemByOutsider = function() {
    ...
    // 添加问题
    $.ajax({
        url: '/SMART/problem/addProblemByOutsider.action',
        type: 'post',
        dataType: 'json',
        contentType: 'application/json',
        data: JSON.stringify({
...
var searchProblemsByPage = function(pageNum){
    ...
    $.ajax({
        url:'/SMART/problem/searchProblemsByPage.action',
        type:'post',
        dataType:'json',
        contentType:'application/json',
        data:JSON.stringify({
