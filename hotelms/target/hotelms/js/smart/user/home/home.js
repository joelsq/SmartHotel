...
requestReminder = function(uid, remindDate) {
    ...
    $.ajax({
        url:'/SMART/reminder/searchReminderByDate.action',
        type:'post',
...
requestRemindDays = function(uid, month) {
    ...
    $.ajax({
        url:'/SMART/reminder/searchRemindDays.action',
        type:'post',
        contentType:'application/json',
        dataType:'json',
...
requestReminderDetail =  function(id, reminderType) {
    ...
    $.ajax({
        url:'/SMART/reminder/searchReminderById_Type.action',
        type:'post',
        contentType:'application/json',
        dataType:'json',
...
var requestFinishReminder = function(element, uid) {
    ...
    $.ajax({
        url:'/SMART/reminder/updateReminderStateById_Type.action',
        type:'post',
        contentType:'application/json',
        dataType:'json',
        data:JSON.stringify({"id":id, "reminderType": reminderType}),
...
requestAjaxRoleArraySave = function(){
	...
	$.ajax({
		type:'post',
		url:'/SMART/HomeUser/requestRole.action',
		success:function(data){			
			console.log(data);
			//逐条保存角色 数值-名称对应关系
			for(item in data){
...
var changePassword = function(){
	...
	$.ajax({
		type:'post',
		url:'/SMART/HomeUser/changePassword.action',
		contentType:'application/json',
		...
		success:function(data){
			...
			//刷新当前页面重新获取session
			window.location.href = "http://" + window.location.host + "/SMART/views/user/home/homeUser.jsp";
		}
	});
}
