...
var requestUnitPrice = function(){
	...
	$.ajax({
		url:'/SMART/userRoom/getLaundryPrice.action',
		type:'post',
		dataType:'json',
...
var requestWash = function(pageNum){
	...
	$.ajax({
		url:'/SMART/userRoom/searchWash.action',
		type:'post',
		dataType:'json',
...
var requestAddServiceWash = function(){
	...
	$.ajax({
		url:'/SMART/userRoom/addWash.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
...
var searchWashById = function(id){
	...
	$.ajax({
		url:'/SMART/userRoom/searchWashById.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
...
var updateServiceWashEdit = function(id){
	...
	$.ajax({
		url:'/SMART/userRoom/updateWashById.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
		data:JSON.stringify({'id': id,
...
var serviceWashDelete = function(id){
	...
	$.ajax({
		url:'/SMART/userRoom/deleteWash.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
		data:JSON.stringify({"id":id}),
...
var exportList = function(){
	...
	$.ajax({
		url:'/SMART/userRoom/searchAllWashes.action',
		type:'post',
		dataType:'json',
