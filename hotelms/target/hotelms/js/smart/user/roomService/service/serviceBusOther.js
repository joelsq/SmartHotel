...
var searchBusOther = function(pageNum){
	...
	$.ajax({
		url:'/SMART/userRoom/searchOtherFaresByPage.action',
		type:'post',
		dataType:'json',
...
var requestAddBusOther = function(){
	...
	$.ajax({
		url:'/SMART/userRoom/addOtherFare.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
...
var searchBusOtherEdit = function(id){
	...
	$.ajax({
		url:'/SMART/userRoom/searchOtherFareById.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
...
var serviceBusOtherDelete = function(id){
	...
	$.ajax({
		url:'/SMART/userRoom/deleteOtherFareById.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
		data:JSON.stringify({"id":id}),
...
var updateBusOther = function(id){
	...
	$.ajax({
		url:'/SMART/userRoom/updateOtherFareById.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
		data:JSON.stringify({"id" : id,
...
var exportList = function(){
	...
	$.ajax({
		url:'/SMART/userRoom/searchAllOtherFares.action',
		type:'post',
		dataType:'json',
