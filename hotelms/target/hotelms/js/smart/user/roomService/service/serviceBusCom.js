...
var searchFareByDate = function(pageNum, date){
	...
	$.ajax({
		url:'/SMART/userRoom/searchFares.action',
		type:'post',
		dataType:'json',
...
var searchBusCom = function(){
	...
	$.ajax({
		url:'/SMART/userRoom/searchFare.action',
		type:'post',
		dataType:'json',
		contentType:'application/json',
...
var requestAddServiceBus = function(){
	...
	$.ajax({
		url:'/SMART/userRoom/addFare.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
...
var searchBusComEdit = function(id){
	...
	$.ajax({
		url:'/SMART/userRoom/searchFareById.action',
		type:'post',
		dataType:'json',
		contentType:'application/json',
		data:'{"id":'+ id +'}',
...
var requestUpdateServiceBus = function(id){
	...
	$.ajax({
		url:'/SMART/userRoom/updateFare.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
...
var serviceBusComDelete = function(id){
	...
	$.ajax({
		url:'/SMART/userRoom/deleteFare.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
...
var exportList = function(){
	...
	$.ajax({
		url:'/SMART/userRoom/searchAllFares.action',
		type:'post',
		dataType:'json',
