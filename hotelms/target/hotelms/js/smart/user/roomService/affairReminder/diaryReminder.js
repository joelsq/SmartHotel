...
var searchDiaryReminderByPage = function(pageNum){
	...
	$.ajax({
		url:'/SMART/reminder/searchDiaryRemindersByPage.action',
		type:'post',
		dataType:'json',
...
var requestAddDiaryReminder = function(){
	...
	$.ajax({
		url:'/SMART/reminder/addDiaryReminder.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
		data:JSON.stringify({"uid" : uid,
...
var searchDiaryReminderDetail = function(id){
	...
	$.ajax({
		url:'/SMART/reminder/searchDiaryReminderById.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
...
var requestDeleteDiaryReminder = function(id){
	...
	$.ajax({
		url:'/SMART/reminder/deleteDiaryReminderById.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
		data:JSON.stringify({"id":id}),
...
var updateDiaryReminder = function(id){
	...
	$.ajax({
		url:'/SMART/reminder/updateDiaryReminderById.action',
		type:'post',
		contentType:'application/json',
		dataType:'json',
        data:JSON.stringify({"id" : id,
