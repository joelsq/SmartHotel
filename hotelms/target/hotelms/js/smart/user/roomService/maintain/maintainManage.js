...
var requestMaintainList = function(pageNum){
	...
	$.ajax({
		url:'/SMART/problem/searchProblemsManage.action',
		type:'post',
		dataType:'json',
...
// 	closeConfirmDiv();
// 	// $.ajax({
// 	// 	url:'/SMART/userRoom/buyGoods.action',
// 	// 	type:'post',
// 	// 	contentType:'application/json',
// 	// 	dataType:'json',
// 	// 	data:'{}',
...
var deleteProblem = function(problemID) {
	...
	$.ajax({
        url:'/SMART/problem/deleteInProblemManage.action',
            type:'post',
            dataType:'json',
            contentType:'application/json',
            data:'{"ID":'+ problemID  + '}',
...
var delayDeal = function(problemID){
    ...
    $.ajax({
        url:'/SMART/problem/delayDealInProblemManage.action',
        type:'post',
        dataType:'json',
        contentType:'application/json',
        data:'{"ID":'+ problemID  + '}',
