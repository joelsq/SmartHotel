...
requestAjaxRoleArraySave = function(){
	...
	$.ajax({
		type:'post',
		url:'/SMART/HomeAdmin/requestRole.action',
...
var requestAjaxUserList = function(pageNum){
	...
	$.ajax({
		type:'post',
		url: "/SMART/HomeAdmin/searchUserList/"+ pageNum +'.action',
		success:function(data){
			console.log(data);
			//?? 转成Json格式
			var JsonData = data;
...
var resetPasswd = function(id,username){
	...
	$.ajax({
		type:'post',
		url:'/SMART/HomeAdmin/resetPasswd/'+ parseInt(id) +'.action',
		success:function(data){
			//console.log(data);
			if(data){
...
var forbidUser = function(id,username){
	...
	$.ajax({
		type:'post',
		url:'/SMART/HomeAdmin/forbidUser/'+ parseInt(id) +'.action',
		success:function(data){
			//console.log(data);
			// data为int数组
			if(data){
				...
				if(data==1){
					alert("成功禁用用户！");
					window.location.href = "/SMART/views/admin/userList.jsp";
				}
				else if(data == 0){
					alert("禁用用户失败！");
				}
...
var enableUser = function(id,username){
	...
	$.ajax({
		type:'post',
		url:'/SMART/HomeAdmin/enableUser/'+ parseInt(id) +'.action',
		success:function(data){
			//console.log(data);
			// data为int数组
			if(data){
...
var requestAjaxAddUser = function(){
	...
	$.ajax({
		type:'post',
		url:'/SMART/HomeAdmin/addUser.action',
...
var requestAjaxDepart = function(){
	...
	$.ajax({
		type:'post',
		url:'/SMART/HomeAdmin/requestDepart.action',
		success:function(data){
			//console.log(data);
...
var requestChangeRole = function() {
    ...
    $.ajax({
        type:'post',
        url:'/SMART/HomeAdmin/changeRole.action',
        contentType:'application/json',
        dataType:"json",
