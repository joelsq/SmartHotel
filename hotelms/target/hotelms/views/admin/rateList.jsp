...
<link href="${pageContext.request.contextPath}/css/smart/admin/public.css"
	rel="stylesheet" type="text/css" />
<link href="${pageContext.request.contextPath}/css/smart/admin/rate.css"
	rel="stylesheet" type="text/css" />
<title>能源费管理</title>
</head>
<body>
	...
	<div class="nav-second">
		<div class="toolbar">
			<div class="nav-secondul">
				<ul>
					<li class="liactive"><a
						href="${pageContext.request.contextPath }/views/admin/rateList.jsp">能源费管理</a>
					</li>
					<li class="linormal"><a
						href="${pageContext.request.contextPath }/views/admin/rateLaundry.jsp">洗衣费管理</a></li>
					<li class="linormal"><a
						href="${pageContext.request.contextPath }/views/admin/rateOther.jsp">其他费用管理</a>
					</li>
				</ul>
			</div>
		</div>
