...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/css/smart/user/tenant/guestList.css"
	rel="stylesheet" type="text/css" />
<title>租客列表</title>
</head>
<body>
		...
		<div class="main-page">
			...
			<div class="main" style="margin-top: -20px;">
				<div class="main-title">
					<input type="text" placeholder="房间号..." /> <input type="text"
						placeholder="姓名..." /> <a class="btnSearch">搜索</a> <a
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/smart/user/tenant/guestList.js"></script>
