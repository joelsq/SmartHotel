...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath }/css/smart/user/tenant/generalMap.css"
	rel="stylesheet" type="text/css" />
...
<body>
		...
		<div class="main-page">
			...
			<div class="hint">
				<div class="hint-content">
					<ul>
						<li><div class="hint-circle"></div>
							<span class="span">SPC</span></li>
						<li><div class="hint-circle"></div>
							<span class="span">小业主</span></li>
						<li><div class="hint-circle"></div>
							<span class="span">待租</span></li>
						<li><div class="hint-circle"></div>
							<span class="span">已租</span></li>
						<li><div class="hint-circle"></div>
							<span class="span">其他使用</span></li>
						<li><div class="hint-circle"></div>
							<span class="span">非管理</span></li>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/smart/user/tenant/generalMap.js"></script>
	<script>
		getRoomState();
	</script>
</body>
