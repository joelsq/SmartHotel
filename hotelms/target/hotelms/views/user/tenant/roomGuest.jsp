...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath }/css/smart/user/tenant/roomGuest.css"
	rel="stylesheet" type="text/css" />
<title>房间信息</title>
</head>
<body>
	...
	<div class="body-content">
		...
		<div style="float: right;">
			<a class="btn btngoback" href="generalMap.jsp">返回一览图</a> <a
				class="btn btngoback" href="guestList.jsp">返回一览表</a>
		</div>
	...
	<div class="manage">
		<div class="man-content">
			<div class="man-title">
				<span class="span">添加房源信息</span> <span class="cross"
					onclick="crossQuit();">x</span>
			</div>
			<div class="man-body">
				<div id="man-type" class="item">
					...
					<div class="item-content">
						...
						<a class="btn btn-item" id="replaceroom"
							onclick="replaceChange(this);">替换房源</a> <a class="btn btn-item"
							id="deleteroom" onclick="delChange(this);">退还房源</a>
					</div>
				</div>
				...
				<div id="room-replace" class="item">
					...
					<div class="item-content">
						<input type="text" id="replace_room" />
					</div>
				</div>
				...
				<div id="com" class="item">
					...
					<div class="item-content">
						<input type="text" value="无" id="commend" />
					</div>
				</div>
			</div>
			<div class="man-foot">
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/smart/user/tenant/roomGuest.js"></script>
	<script>
		$(function(){
			if (<%=rid%>!=null) {
				// 获取房屋信息
