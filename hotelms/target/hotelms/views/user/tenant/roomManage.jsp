...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/css/smart/user/tenant/roomManage.css"
	rel="stylesheet" type="text/css" />
<title>房源管理</title>
</head>
<body>
		...
		<div class="main-page">
			...
			<div class="main" style="margin-top: -20px;">
				<div class="main-title">
					<input type="text" placeholder="房间号..." id="roomNumber" /> <input
						type="text" placeholder="房源类型..." id="roomType" /> <a
						class="btnSearch"
						onclick="getRoomManageInfo($('#roomNumber').val(),$('#roomType').val(),parseInt(1));">搜索</a>
					<a class="btn btn-edit" style="margin-left: 10px;"
						onclick="printList();">打印</a> <a class="btn btn-edit"
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/smart/user/tenant/roomManage.js"></script>
