...
<body>
	...
	<div class="main">
		<div class="main-page">
			<div class="nav-path">
				...
				<i class="icon-path"></i> <a href="shopManage.jsp">小卖部</a> <a
					class="btn btn-new new" href="shopNew.jsp" style="float: right;">新增商品</a>
			</div>
				...
				<div class="main-page">
					<div class="nav-path">
						<div class="chooseGoodsName">
							<span class="span">商品名：</span> <input type="text" value=""
								id="shop_id" />
						</div>
	...
	<div id="buyGoodsMenu" class="menuDiv">
		<div class="menuContent">
			<div class="menuTitle">
				买入商品 <span onclick="closeBuyGoodsDiv();">×</span>
			</div>
			<div class="menuBody">
				<div class="menuContent">
					请输入买入商品&nbsp;<span class="goodsName"></span>&nbsp;数量：&nbsp; <input
						type="text" value="2" />
				</div>
				<a class="btn btn-submit" onclick="requestBuyGoods();">确认买入</a>
			</div>
			<span style='display: none;' id='buyGoodsId'></span> <span
				style='display: none;' id='buyMoney'></span>
		</div>
	</div>
	<!-- 买入商品弹出框 end -->
	...
	<div id="saleGoodsMenu" class="menuDiv">
		<div class="menuContent">
			<div class="menuTitle">
				卖出商品 <span onclick="closeSaleGoodsDiv();">×</span>
			</div>
			<div class="menuBody">
				<div class="menuContent">
					请输入卖出商品&nbsp;<span class="goodsName"></span>&nbsp;数量：&nbsp; <input
						type="text" value="2" />
				</div>
				<a class="btn btn-submit" onclick="requestSaleGoods();">确认卖出</a>
			</div>
			<span style='display: none;' id='saleGoodsId'></span> <span
				style='display: none;' id='saleMoney'></span>
		</div>
	</div>
	<!-- 卖出商品弹出框 end -->
	...
	<div id="useGoodsMenu" class="menuDiv">
		<div class="menuContent">
			<div class="menuTitle">
				废弃商品 <span onclick="closeUseGoodsDiv();">×</span>
			</div>
			<div class="menuBody">
				<div class="menuContent">
					请输入废弃商品&nbsp;<span class="goodsName"></span>&nbsp;数量：&nbsp; <input
						type="text" value="2" />
				</div>
				<a class="btn btn-submit" onclick="requestUseGoods();">确认废弃</a>
			</div>
			<span style='display: none;' id='useGoodsId'></span> <span
				style='display: none;' id='useMoney'></span>
		</div>
	</div>
	<!-- 废弃商品弹出框 end -->
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/smart/user/office/shopManage.js"></script>
	<script>
		// 创建时间插件 并 请求本月所有商品信息
