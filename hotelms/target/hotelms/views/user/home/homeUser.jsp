...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/css/smart/user/home/home.css"
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/css/smart/user/roomService/roomService.css"
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/css/smart/user/roomService/roomServiceIndex.css"
	rel="stylesheet" type="text/css" />
<script>
	//将英文月份转换成数字月份
...
<body>
	...
	<div class="title">
		<div class="title-content">
			...
			<div class="btn btn-change btnchange" style="margin-right: 120px;">
				<a
					href="${pageContext.request.contextPath}/views/user/roomItem/assetRepairNewByOutsider.jsp">客房报修</a>
			</div>
			<div class="btn btn-change btnchange">
				<a
					href="${pageContext.request.contextPath}/views/user/roomService/maintain/maintainEmergencyNew.jsp">紧急事件申报</a>
			</div>
		</div>
	</div>
	<div class="content">
			...
			<div class="body">
				...
				<div class="index-list">
					<div class="left-index">
						<ul>
							<li><img
								src="${pageContext.request.contextPath}/img/roomService/telephone.svg">
								<span>客房服务</span></li>
						</ul>
					</div>
				</div>
				<div class="content-title content-title-index active content-wash">
					<ul>
						<li><a
							href="${pageContext.request.contextPath}/views/user/roomService/service/serviceWash.jsp">洗衣单收费</a></li>
						<li><a
						...
						<li><a
							href="${pageContext.request.contextPath}/views/user/roomService/service/serviceBus.jsp">车费</a></li>

						<li><a
							href="${pageContext.request.contextPath}/views/user/office/shopManage.jsp">小卖铺</a></li>
						<li><a
							href="${pageContext.request.contextPath}/views/user/roomService/source/sourceIndex.jsp">能源费结算</a></li>
						<li><a
							href="${pageContext.request.contextPath}/views/user/roomService/expense/expenseIndex.jsp">LE承担费用</a></li>
						<li><a href="#">月结管理</a></li>
					</ul>
				</div>
				<!-- 客房服务 end -->
				...
				<div class="content-title content-title-index">
					<ul>
						<li><a
							href="${pageContext.request.contextPath}/views/user/roomItem/assetRepairOverview.jsp">报修处理</a></li>
						<li><a
							href="${pageContext.request.contextPath}/views/user/roomService/maintain/maintainCheck.jsp">检查检修</a></li>
						<li><a
							href="${pageContext.request.contextPath}/views/user/roomService/maintain/maintainManage.jsp">维修管理</a></li>
						<li><a
							href="${pageContext.request.contextPath}/views/user/roomService/maintain/maintainStat.jsp">维修统计</a></li>
						<li><a
							href="${pageContext.request.contextPath}/views/user/roomItem/itemIndex.jsp">客房物品管理</a></li>
					</ul>
				</div>
				<!-- 客房维修 end -->
				...
				<div class="content-title content-title-index">
					<ul>
						...
						<li><a
							href="${pageContext.request.contextPath}/views/user/tenant/guestList.jsp">租客一览表</a></li>
						<li><a
							href="${pageContext.request.contextPath}/views/user/tenant/roomManage.jsp">房源管理</a></li>
						<li><a href="#">房屋退租</a></li>
					</ul>
				</div>
				<!-- 能源费结算 end -->
				...
				<div class="content-title content-title-index">
					<ul>
						...
						<li><a
							href="${pageContext.request.contextPath}/views/user/roomService/expense/expenseStatistics.jsp">客房费用统计</a></li>
				...
				<div class="index-list">
					<div class="left-index">
						<ul>
							<li><img
								src="${pageContext.request.contextPath}/img/roomService/calendar.svg">
								<span>办公管理</span></li>
						</ul>
					</div>
				</div>
				<div class="content-title content-title-index">
					<ul>
						<li><a
							href="${pageContext.request.contextPath}/views/user/roomService/affairReminder/mailboxIndex.jsp">站内信</a></li>
						<li><a
							href="${pageContext.request.contextPath}/views/user/roomService/affairReminder/diaryOverview.jsp">备忘录</a></li>
						<li><a
							href="${pageContext.request.contextPath}/views/user/roomItem/planList.jsp">物品申请</a></li>
						<li><a
							href="${pageContext.request.contextPath}/views/user/roomService/maintain/maintainEmergencyDealing.jsp">紧急事件处理</a></li>
						<li><a
							href="${pageContext.request.contextPath}/views/user/roomService/affairReminder/systemOverview.jsp">公告</a></li>
	...
	<div id="reminderDetailMenu" class="addItemDiv">
		<div class="facContent">
			<div class="fac-title">
				事务详情 <span onclick="closeReminderDetailDiv();">×</span>
			</div>
			<div class="fac-body">
				<div id="room-number" class="item">
					<span class="span">主题：</span>
					<div class="item-content">
						<input id="reminderTitle" type="text" value="" readonly />
					</div>
				</div>
			...
			<div class="fac-foot">
				<span id="currentDate" style="display: none"></span> <a
					class="btn btn-submit" id="finishBtn"
					onclick="requestFinishReminder(this, '${curUser.ID}');">确认完成</a>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/plugin/clndr/underscore.min.js"></script>
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/plugin/clndr/moment.min.js"></script>
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/plugin/clndr/clndr.min.js"></script>
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/smart/user/home/home.js"></script>
	<script type="text/javascript"
