				...
				<div class="body-content">
					<ul>
						<li id="dropDownList"><span>收件人：</span> <input type="text"
							id="dropDownInput" value="" rid="" readonly />
							<div class="dropDownMenu">
								<ul>
								</ul>
							</div> <a onclick="clearReceivers();" class="btn"
							style="margin-left: 10px;">清空</a></li>
						...
						<li><a onclick="requestAddMailReminder();"
							class="btn btn-goback goback">发送</a></li>
					</ul>
				</div>
			</div>
		</div>
