...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/css/smart/user/roomService/affairReminder/diaryOverview.css"
	rel="stylesheet" type="text/css" />
<title>备忘录</title>
</head>
<body>
		...
		<div class="main-page">
			...
			<div class="nav-path">
				<span>关键字：</span><input id="keyword" type="text" value=""> <span
					...
					style="margin-left: 30px;" onclick="searchDiaryReminderByPage(1);">搜索</a>
			</div>
					...
					<table>
						...
						<tbody id="reminderOverviewTbody">
							<tr>
								...
								<td>2017-06-08</td>
								<td>完成</td>
								<td><a href="#" class="detail">详情</a><a href="#"
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/smart/user/roomService/affairReminder/diaryReminder.js"></script>
