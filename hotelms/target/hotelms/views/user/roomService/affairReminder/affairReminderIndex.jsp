		...
		<div class="main-page">
			...
			<div class="body">
				<div class="content-title content-title-index">
					<ul>
						<li><div class="icon"></div> <a href="mailboxIndex.jsp">站内信</a></li>
						<li><div class="icon"></div> <a href="diaryOverview.jsp">个人日志</a></li>
						<li><div class="icon"></div> <a href="systemOverview.jsp">系统提醒</a></li>
					</ul>
				</div>
			</div>
		</div>
