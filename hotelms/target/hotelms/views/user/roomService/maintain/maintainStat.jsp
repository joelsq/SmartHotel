...
<link
	href="${pageContext.request.contextPath}/css/smart/user/roomService/maintain/maintainStat.css"
	rel="stylesheet" type="text/css" />
<title>维修统计</title>
</head>
<body>
		...
		<div class="main-page">
			<div class="nav-path">
				<a href="../../home/homeUser.jsp" title="回到首页"><i
					...
					href="javascript:void(0);" style="font-size: 14px;">维修统计</a>
			</div>
			<div class="bill-area">
				<div class="table-title">
					<div class="maintainItemType">
						<div class="search">
							<span>房间号：</span><input id="searchRoomNum" type="text"
								value="W33-3">
						</div>
						<!-- 双日历 start -->
					...
					<table>
						<thead>
							...
							<tr id='theadSecond'>
								...
								<th><span>三级</span></th>
								<th><span>四级</span></th>
								<th><span>未解决第四等级问题</span></th>
								<th><span>其余未解决</span></th>
							</tr>
						</thead>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/smart/user/roomService/maintain/maintainStat.js"></script>
	<script>
