...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/css/smart/user/roomService/source/sourceGas.css"
	rel="stylesheet" type="text/css" />
<title>燃气费</title>
</head>
<body>
	...
	<div class="main">
		<div class="main-page">
			...
			<div class="bill-area">
				<input id="roomNumber" type="text" class="search-input"
					placeholder="请输入房间号..." /> <a class="btn btn-edit btnSearch"
					onclick="requestGas($('#roomNumber').val(),parseInt(1))">搜索燃气费</a>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/smart/user/roomService/source/sourceGas.js"></script>
	<script type="text/javascript">
	    // 拉取第一页餐费信息
