...
<body>
				...
				<div class="body-content">
					<ul>
						<li><span class="span">房间号：</span> <input
							id="sourceRoomNumber" type="text" value="<%=rnum%>"
							disabled="disabled" /> <span class="red red-right">*&nbsp;必填</span>
						</li>
						<li><span class="span">表数：</span> <input id="curVal"
							type="text" value="0" /> <span class="red red-right" id="error"></span>
						</li>
						<li><span class="span">更新时间:</span><input type="text"
							id='readtime' class="pack_maintain" id="change_time" /></li>
						<li><span class="span">计费月份:</span><input type="text"
							id='month' placeholder='请按照"1月"输入...'></li>
						<li><span class="span">更新日期:</span><input type="text"
							id="pack_maintain" disabled="disabled" /></li>
						<li><span class="span"></span> <a
							onclick="addsource('<%=rnum%>','<%=type%>','<%=guest%>','<%=meter%>');"
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/smart/user/roomService/source/sourceNew.js"></script>
	<script type="text/javascript">
