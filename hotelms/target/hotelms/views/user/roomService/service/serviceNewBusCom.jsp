		...
		<div class="main-page">
			<div class="nav-path">
				...
				<i class="icon-path"></i> <a href="serviceBusCom.jsp">通勤车</a> <i
					class="icon-path"></i> <a href="javascript:void(0);">新增通勤车车费记录</a>
			</div>
			<div class="body">
				<div class="body-content">
					<ul>
						<li id="dateLi"><span>通勤日期：</span><input id="newBusDate"
							type="text" class="pack_maintain" /></li>
						...
						<li id="othersLi"><span>其他人员：</span><input id="othersName"
							type="text" value="" /></li>
						<a href="javascript:void(0);" class="btn btn-goback"
							id="btn-search" onclick="searchBusCom();">搜索本月通勤车记录</a>
						...
						<li class="monthTotalLi"><span>本月合计：</span><input
							id="monthTotal" type="text" value="0" disabled="disabled" /> <a
							onclick="addserviceBus();" class="btn btn-goback goback">确认添加</a></li>
					</ul>
				</div>
			</div>
		</div>
