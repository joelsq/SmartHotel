...
<body>
	...
	<div class="main">
		<div class="main-page">
			<div class="nav-path">
				...
				<i class="icon-path"></i> <a href="javascript:void(0);">擦鞋费</a>
			</div>
				...
				<div class="search">
					...
					<div style="float: right">
						<a class="btn btn-edit btnEdit"
							onclick="requestFirstShoeCleaningByRoomNum(this);">搜索</a> <a
							class="btn btn-edit btnEdit" onclick="exportList();">导出</a> <a
							class="btn btn-edit btnEdit" onclick="printList('hahaha');">打印</a>
					</div>
				</div>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/smart/user/roomService/service/serviceShoeCleaning.js"></script>
	<script type="text/javascript">
        var date = new Date();
