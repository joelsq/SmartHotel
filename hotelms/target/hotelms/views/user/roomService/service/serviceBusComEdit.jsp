...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/css/smart/user/roomService/service/serviceBusNew.css"
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/css/smart/user/roomService/service/serviceBusEdit.css"
	rel="stylesheet" type="text/css" />
	...
	<div class="main">
		<div class="main-page">
			<div class="nav-path">
				...
				<i class="icon-path"></i> <a id="serviceType" href="serviceBus.jsp">车费</a>
				<i class="icon-path"></i> <a href="serviceBusCom.jsp">通勤车</a> <i
					class="icon-path"></i> <a href="javascript:void(0);">编辑通勤车车费记录</a>
			</div>
			<div class="body">
				<div class="body-content">
					<ul>
						<li id="dateLi"><span>通勤日期：</span><input
							id="editServiceBusDate" type="text" class="pack_maintain" /></li>
						<li id="roomNumLi"><span>房间号：</span><input
							id="editServiceBusRoomNum" type="text" disabled="disabled" /></li>
						<li id="nameLi"><span>客户姓名：</span><input id="guestName"
							type="text" disabled="disabled" /></li>
						<li id="othersLi"><span>其他人员：</span><input
							id="editOthersName" type="text" /></li>
						...
						<li><span>本月合计：</span><input id="monthTotal" type="text"
							value="0" disabled="disabled" /> <a
							onclick="requestUpdateServiceBus(${param.id});"
							class="btn btn-goback goback">确认更新</a></li>
					</ul>
				</div>
			</div>
		</div>
