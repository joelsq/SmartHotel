...
<link
	href="${pageContext.request.contextPath}/css/smart/user/roomService/service/serviceWaterBill.css"
	rel="stylesheet" type="text/css" />
<title>饮用水费</title>
</head>
<body>
	...
	<div class="main">
		<div class="main-page">
			<div class="nav-path">
				...
				<i class="icon-path"></i> <a href="javascript:void(0)">饮用水费</a>
			</div>
			...
			<div class="bill-area">
				<div class="search">
					...
					<div style="float: right">
						<a class="btn btn-edit btnEdit" onclick="searchWaterBill(1);"
