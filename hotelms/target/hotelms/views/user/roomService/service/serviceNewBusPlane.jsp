		...
		<div class="main-page">
			<div class="nav-path">
				...
				<i class="icon-path"></i> <a href="serviceBus.jsp">车费</a> <i
					...
					class="icon-path"></i> <a href="javascript:void(0);">新增接送机车费记录</a>
			</div>
			<div class="body">
				<div class="body-content">
					<ul>
						<li>
							<div class="eventType">
								<input type="radio" name="eventType" id="eventType"
									checked="checked"><span class="span">接机</span> <input
									type="radio" name="eventType"><span class="span">送机</span>
							</div>
						</li>
						...
						<li><span class="span">联络人电话：</span><input type="text"
							value="" /></li>
						<li><span class="span"></span><a onclick="addBusPlane();"
