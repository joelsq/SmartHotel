		...
		<div class="main-page">
			<div class="nav-path">
				...
				<i class="icon-path"></i> <a id="serviceType"
					href="serviceShoeCleaning.jsp">擦鞋费</a> <i class="icon-path"></i> <a
					href="javascript:void(0);">新增擦鞋费记录</a>
			</div>
			<div class="body">
				<div class="body-content">
					<ul>
						<li><span class="span">房间号：</span> <input
							...
							onblur="associateGuestName(this);associateCleaningShoesSum();" />
						...
						<li><span class="span">数量：</span><input type="text"
							id="count" value="0" oninput="associateCleaningShoesSum();" />双</li>
						<li><span class="span">金额：</span><input type="text" id="sum"
							value="0" disabled="disabled" />元</li>
						...
						<li><span class="span">备注：</span><input type="text"
							id="comment" value="无" /></li>
						<li><span class="span">擦鞋日期：</span><input type="text"
							value="" id="time" class="pack_maintain" /></li>
						<li><span class="span"></span><a
							onclick="addservice_ShoeCleaning();"
