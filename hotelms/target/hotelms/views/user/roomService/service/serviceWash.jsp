...
<link
	href="${pageContext.request.contextPath}/css/smart/user/roomService/service/serviceWash.css"
	rel="stylesheet" type="text/css" />
<link
		...
		<div class="main-page">
			<div class="nav-path">
				<a href="../../home/homeUser.jsp" title="回到首页"><i
					class="icon-home"></i></a> <i class="icon-path"></i> <a href="">洗衣单收费</a>
			</div>
			...
			<div class="bill-area">
				<div class="search" style="padding-bottom: 20px">
					...
					<div style="float: right">
						<a class="btn btn-edit btnEdit" onclick="requestWash(1);"
