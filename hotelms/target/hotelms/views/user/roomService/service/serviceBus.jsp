...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/css/smart/user/roomService/service/serviceIndex.css"
	rel="stylesheet" type="text/css" />
<title>车费</title>
</head>
<body>
	...
	<div class="main">
		<div class="main-page">
			<div class="nav-path">
				...
				<i class="icon-path"></i> <a href="serviceBus.jsp">车费</a>
			</div>
			<div class="body">
				<div class="content-title content-title-index">
					<ul>
						<li><div class="icon"></div>
							<a href="serviceBusCom.jsp">通勤车</a></li>
						<li><div class="icon"></div>
							<a href="serviceBusPlane.jsp">接送机</a></li>
						<li><div class="icon"></div>
							<a href="serviceBusOther.jsp">其它</a></li>
					</ul>
				</div>
			</div>
		</div>
