...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/css/smart/user/roomService/service/serviceBusPlane.css"
	rel="stylesheet" type="text/css" />
<title>接送机</title>
</head>
<body>
		...
		<div class="main-page">
			<div class="nav-path">
				...
				<i class="icon-path"></i> <a href="serviceBus.jsp">车费</a> <i
					class="icon-path"></i> <a href="serviceBusPlane.jsp">接送机</a>
			</div>
				...
				<div class="search">
					...
					<div style="float: right">
						<a class="btn btn-edit btnEdit" style="margin-left: 100px;"
							onclick="searchBusPlane(1);">搜索</a> <a
