		...
		<div class="main-page">
			<div class="nav-path">
				...
				<i class="icon-path"></i> <a id="serviceType"
					href="serviceTakeaway.jsp">餐费</a> <i class="icon-path"></i> <a
					href="javascript:void(0);">编辑餐费记录</a>
			</div>
			<div class="body">
				<div class="body-content">
					<ul>
						...
						<li id="resSort"><span class="span">餐厅：</span><input
							type="text" id="resInput" value="其他" />
							<div class="resMenu">
								<ul>
								</ul>
							</div></li>
						<li><span class="span">金额：</span><input type="text" value=""
							id="count" />元</li>
						<li><span class="span"></span> <input type="radio" value="0"
							name="pay" checked="checked" />现金 <input type="radio" value="1"
							name="pay" />月结</li>
						<li><span class="span">备注：</span><input type="text" value=""
							id="comment" /></li>
						<li><span class="span">点餐日期：</span><input type="text"
							value="" id="time" class="pack_maintain" /></li>
						<li id="staffSort"><span class="span">点餐人：</span><input
							value="0 0" type="text" id="staffInput" />
							<div class="staffMenu">
								<ul id="staff">
								</ul>
							</div></li>
						<li><span class="span"></span><a
							onclick="updateServiceTakeawayEdit(${param.id});"
