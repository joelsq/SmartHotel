			...
			<div class="body">
				<div class="body-content">
					<ul>
						...
						<li><span class="span">物品：</span><input type="text" id="item"
							value="无" /></li>
						<li><span class="span">数量：</span><input type="text"
							id="count" value="0" />件</li>
						<li><span class="span">垫付费：</span><input type="text" id="sum"
							value="0" />元</li>
						<li><span class="span">服务费：</span><input type="text" id="tip"
							value="0" />元</li>
						...
						<li><span class="span"></span><a
							onclick="addservice_Shopping();" class="btn btn-goback goback">确认添加</a></li>
					</ul>
				</div>
			</div>
		</div>
