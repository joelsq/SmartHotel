...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/css/smart/user/roomItem/itemRepoOverview.css"
	rel="stylesheet" type="text/css" />
<link
...
<body>
				...
				<div class="main-page">
					...
					<div class="nav-path">
						<a href="../home/homeUser.jsp" title="回到首页"><i
							...
							href="itemIndex.jsp">客房物品管理</a> <i class="icon-path"></i> <a
							href="itemRepoOverview.jsp">库房物品统计</a>
					</div>
					...
					<div class="nav-path" style="margin-top: -20px;">
						...
						<span style="margin-left: 30px;">库房号：</span><input id="repoNum"
							type="text" value=""> <a class="btn btn-edit btnEdit"
							style="margin-left: 30px;" onclick="requestItemByItemType(1);">搜索</a>
						<a class="btn btn-edit btnEdit btnRight" onclick="exportList();"
							style="margin-left: 298px;">导出</a> <a
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/smart/user/roomItem/itemRepoOverview.js"></script>
