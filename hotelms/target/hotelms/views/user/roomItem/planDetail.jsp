...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/css/smart/user/roomItem/planDetail.css"
	rel="stylesheet" type="text/css" />
<title>采购计划详情</title>
</head>
<body>
	...
	<div class="main">
		<div class="planHead">
			<div class="planName">
				<span class="title">计划名称：<%=planName%></span> <span id="planID"
					style="display: none;"><%=planID%></span>
			</div>
	...
	<div class="addItemDiv">
		<div class="facContent">
			<div class="fac-title">
				执行采购计划 <span onclick="closeCaigouDiv();">×</span>
			</div>
			<div class="fac-body">
				...
				<div id="fac-total" class="item">
					...
					<div class="item-content">
						<input type="text" value="1"
							oninput="calCaigouTotalPrice(this.value);" />
					</div>
				</div>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/smart/user/roomItem/planDetail.js"></script>
	<script>(function(){
			requestPlanDetail();
